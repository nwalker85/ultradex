...
| JS-U01 | correction review | 38 tests pass with one strict MCP XFAIL; authentication, executable worker registry, scoped idempotency, bounded GraphQL reads, honest nullable freshness, shared OpenAPI/runtime validation, compile, build, and compatibility wheel checks pass. |
